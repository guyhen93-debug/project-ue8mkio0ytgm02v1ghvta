  ...
  return (
    <Card className="industrial-card">
      <CardHeader className="p-3 sm:p-6 pb-3">
        <CardTitle className="text-lg sm:text-xl font-bold">כלי ניהול מהירים</CardTitle>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {tools.map((tool) => (
            <Button
              key={tool.title}
              variant="outline"
              className="h-auto p-4 flex flex-col items-start gap-2 hover:bg-gray-50 transition-colors"
